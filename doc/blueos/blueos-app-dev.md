...
STACKCHAN_IP = "192.168.x.x"  # StackChan の IP

def speak(text: str):
    requests.post(
        f"http://{STACKCHAN_IP}/talk",
        json={"text": text}
    )
...
### 音声操縦
StackChan の音声入力でドローンを操縦するシステムの開発。
